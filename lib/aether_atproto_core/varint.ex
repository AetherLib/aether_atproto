defmodule AetherATProtoCore.Varint do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.Varint.encode(127)
      <<127>>

      iex> AetherATProtoCore.Varint.encode(300)
      <<172, 2>>

      iex> {:ok, 127, <<>>} = AetherATProtoCore.Varint.decode(<<127>>)
      iex> :ok
      :ok
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.Varint.encode(0)
      <<0>>

      iex> AetherATProtoCore.Varint.encode(1)
      <<1>>

      iex> AetherATProtoCore.Varint.encode(127)
      <<127>>

      iex> AetherATProtoCore.Varint.encode(128)
      <<128, 1>>
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.Varint.decode(<<127>>)
      {:ok, 127, <<>>}

      iex> AetherATProtoCore.Varint.decode(<<128, 1, 99>>)
      {:ok, 128, <<99>>}
  """
