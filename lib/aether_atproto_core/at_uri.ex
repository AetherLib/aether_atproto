defmodule AetherATProtoCore.AtUri do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.AtUri.parse_at_uri("at://did:plc:z72i7hdynmk24r6zlsdc6nxd")
      {:ok, %AetherATProtoCore.AtUri{authority: "did:plc:z72i7hdynmk24r6zlsdc6nxd"}}

      # Repository reference (handle)
      iex> AetherATProtoCore.AtUri.parse_at_uri("at://alice.bsky.social")
      {:ok, %AetherATProtoCore.AtUri{authority: "alice.bsky.social"}}

      # Collection reference
      iex> AetherATProtoCore.AtUri.parse_at_uri("at://alice.bsky.social/app.bsky.feed.post")
      {:ok, %AetherATProtoCore.AtUri{authority: "alice.bsky.social", collection: "app.bsky.feed.post"}}

      # Record reference
      iex> AetherATProtoCore.AtUri.parse_at_uri("at://did:plc:z72i7hdynmk24r6zlsdc6nxd/app.bsky.feed.post/3jwdwj2ctlk26")
      {:ok, %AetherATProtoCore.AtUri{authority: "did:plc:z72i7hdynmk24r6zlsdc6nxd", collection: "app.bsky.feed.post", rkey: "3jwdwj2ctlk26"}}

      # With fragment
      iex> AetherATProtoCore.AtUri.parse_at_uri("at://alice.bsky.social/app.bsky.feed.post/123#anchor")
      {:ok, %AetherATProtoCore.AtUri{authority: "alice.bsky.social", collection: "app.bsky.feed.post", rkey: "123", fragment: "anchor"}}
  """

  alias AetherATProtoCore.DID
  ...
  Returns `{:ok, %AetherATProtoCore.AtUri{}}` on success or `{:error, reason}` on failure.
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.AtUri.parse_at_uri("at://alice.example.com/app.bsky.feed.post/123")
      {:ok, %AetherATProtoCore.AtUri{authority: "alice.example.com", collection: "app.bsky.feed.post", rkey: "123"}}

      iex> AetherATProtoCore.AtUri.parse_at_uri("invalid")
      {:error, :invalid_format}

      iex> AetherATProtoCore.AtUri.parse_at_uri("at://")
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.AtUri.parse_at_uri!("at://alice.bsky.social")
      %AetherATProtoCore.AtUri{authority: "alice.bsky.social"}

      iex> AetherATProtoCore.AtUri.parse_at_uri!("invalid")
      ** (AetherATProtoCore.AtUri.ParseError) Invalid AT URI: invalid_format
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.AtUri.valid_at_uri?("at://alice.bsky.social")
      true

      iex> AetherATProtoCore.AtUri.valid_at_uri?("invalid")
      false

      iex> AetherATProtoCore.AtUri.valid_at_uri?(%AetherATProtoCore.AtUri{authority: "alice.bsky.social"})
      true
  """
  ...
  ## Examples
      ...
      iex> at_uri = %AetherATProtoCore.AtUri{authority: "alice.bsky.social"}
      iex> AetherATProtoCore.AtUri.at_uri_to_string(at_uri)
      "at://alice.bsky.social"

      iex> at_uri = %AetherATProtoCore.AtUri{authority: "alice.bsky.social", collection: "app.bsky.feed.post", rkey: "123"}
      iex> AetherATProtoCore.AtUri.at_uri_to_string(at_uri)
      "at://alice.bsky.social/app.bsky.feed.post/123"

      iex> at_uri = %AetherATProtoCore.AtUri{authority: "alice.bsky.social", fragment: "anchor"}
      iex> AetherATProtoCore.AtUri.at_uri_to_string(at_uri)
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.AtUri.authority("at://alice.bsky.social/app.bsky.feed.post/123")
      "alice.bsky.social"

      iex> AetherATProtoCore.AtUri.authority(%AetherATProtoCore.AtUri{authority: "did:plc:z72i7hdynmk24r6zlsdc6nxd"})
      "did:plc:z72i7hdynmk24r6zlsdc6nxd"

      iex> AetherATProtoCore.AtUri.authority("invalid")
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.AtUri.collection("at://alice.bsky.social/app.bsky.feed.post/123")
      "app.bsky.feed.post"

      iex> AetherATProtoCore.AtUri.collection("at://alice.bsky.social")
      nil

      iex> AetherATProtoCore.AtUri.collection(%AetherATProtoCore.AtUri{authority: "alice.bsky.social", collection: "app.bsky.feed.post"})
      "app.bsky.feed.post"
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.AtUri.rkey("at://alice.bsky.social/app.bsky.feed.post/123")
      "123"

      iex> AetherATProtoCore.AtUri.rkey("at://alice.bsky.social/app.bsky.feed.post")
      nil

      iex> AetherATProtoCore.AtUri.rkey(%AetherATProtoCore.AtUri{authority: "alice.bsky.social", collection: "app.bsky.feed.post", rkey: "abc123"})
      "abc123"
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.AtUri.fragment("at://alice.bsky.social#anchor")
      "anchor"

      iex> AetherATProtoCore.AtUri.fragment("at://alice.bsky.social")
      nil

      iex> AetherATProtoCore.AtUri.fragment(%AetherATProtoCore.AtUri{authority: "alice.bsky.social", fragment: "section1"})
      "section1"
  """
