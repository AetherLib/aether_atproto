defmodule AetherATProtoCore.DID do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.DID.parse_did("did:plc:z72i7hdynmk24r6zlsdc6nxd")
      {:ok, %AetherATProtoCore.DID{method: "plc", identifier: "z72i7hdynmk24r6zlsdc6nxd"}}

      iex> AetherATProtoCore.DID.parse_did("did:web:example.com")
      {:ok, %AetherATProtoCore.DID{method: "web", identifier: "example.com"}}

      iex> AetherATProtoCore.DID.parse_did("did:key:zQ3shokFTS3brHcDQrn82RUDfCZESWL1ZdCEJwekUDPQiYBme")
      {:ok, %AetherATProtoCore.DID{method: "key", identifier: "zQ3shokFTS3brHcDQrn82RUDfCZESWL1ZdCEJwekUDPQiYBme"}}

      iex> AetherATProtoCore.DID.parse_did("did:web:example.com:user#fragment")
      {:ok, %AetherATProtoCore.DID{method: "web", identifier: "example.com:user", fragment: "fragment"}}
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.DID.parse_did!("did:plc:z72i7hdynmk24r6zlsdc6nxd")
      %AetherATProtoCore.DID{method: "plc", identifier: "z72i7hdynmk24r6zlsdc6nxd"}

      iex> AetherATProtoCore.DID.parse_did!("invalid")
      ** (AetherATProtoCore.DID.ParseError) Invalid DID: invalid_format
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.DID.valid_did?("did:plc:z72i7hdynmk24r6zlsdc6nxd")
      true

      iex> AetherATProtoCore.DID.valid_did?("invalid")
      false

      iex> AetherATProtoCore.DID.valid_did?(%AetherATProtoCore.DID{method: "plc", identifier: "test"})
      true
  """
  ...
  ## Examples
      ...
      iex> did = %AetherATProtoCore.DID{method: "plc", identifier: "z72i7hdynmk24r6zlsdc6nxd"}
      iex> AetherATProtoCore.DID.did_to_string(did)
      "did:plc:z72i7hdynmk24r6zlsdc6nxd"

      iex> did = %AetherATProtoCore.DID{method: "web", identifier: "example.com", fragment: "key1"}
      iex> AetherATProtoCore.DID.did_to_string(did)
      "did:web:example.com#key1"

      iex> did = %AetherATProtoCore.DID{method: "web", identifier: "example.com", query: "version=1", fragment: "key1"}
      iex> AetherATProtoCore.DID.did_to_string(did)
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.DID.did_method("did:plc:z72i7hdynmk24r6zlsdc6nxd")
      "plc"

      iex> AetherATProtoCore.DID.did_method("did:web:example.com")
      "web"

      iex> AetherATProtoCore.DID.did_method("invalid")
      {:error, :invalid_did}
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.DID.did_identifier("did:plc:z72i7hdynmk24r6zlsdc6nxd")
      "z72i7hdynmk24r6zlsdc6nxd"

      iex> AetherATProtoCore.DID.did_identifier("invalid")
      {:error, :invalid_did}
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.DID.is_method?("did:plc:z72i7hdynmk24r6zlsdc6nxd", "plc")
      true

      iex> AetherATProtoCore.DID.is_method?("did:web:example.com", "plc")
      false

      iex> AetherATProtoCore.DID.is_method?("invalid", "plc")
      false
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.DID.did_fragment("did:web:example.com#key1")
      "key1"

      iex> AetherATProtoCore.DID.did_fragment("did:web:example.com")
      nil
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.DID.did_params("did:web:example.com?version=1&test=true")
      %{"version" => "1", "test" => "true"}

      iex> AetherATProtoCore.DID.did_params("did:web:example.com")
      nil
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.DID.supported_method?("plc")
      true

      iex> AetherATProtoCore.DID.supported_method?("unsupported")
      false
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.DID.supported_methods()
      ["plc", "web", "key"]
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.DID.normalize("DID:PLC:Z72I7HDYNMK24R6ZLSDC6NXD")
      "did:plc:z72i7hdynmk24r6zlsdc6nxd"

      iex> AetherATProtoCore.DID.normalize("DID:WEB:EXAMPLE.COM?VERSION=1#KEY1")
      "did:web:example.com?VERSION=1#KEY1"
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.DID.web_domain("did:web:example.com:path")
      "example.com"

      iex> AetherATProtoCore.DID.web_domain("did:plc:z72i7hdynmk24r6zlsdc6nxd")
      {:error, :not_web_did}
  """
