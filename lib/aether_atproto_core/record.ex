defmodule AetherATProtoCore.Record do
  @moduledoc """
  ...
  Parse from external sources (XRPC responses):
      ...
      AetherATProtoCore.Record.from_map(%{
        "$type" => "app.bsky.feed.post",
        "text" => "Hello, ATProto!",
  ...
  Convert to map for XRPC requests:
      ...
      record = %AetherATProtoCore.Record{type: "app.bsky.feed.post", data: %{"text" => "Hi"}}
      AetherATProtoCore.Record.to_map(record)
  ...
  Use Elixir's pattern matching for working with records:
      ...
      %AetherATProtoCore.Record{type: type, data: data} = record

      # Update data immutably
      updated = %{record | data: Map.put(record.data, "text", "Updated")}

      # Match on specific types
      def handle_record(%AetherATProtoCore.Record{type: "app.bsky.feed.post"} = post) do
        # Handle post
      end
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.Record.from_map(%{
      ...>   "$type" => "app.bsky.feed.post",
      ...>   "text" => "Hello",
      ...>   "createdAt" => "2024-01-15T12:00:00Z"
      ...> })
      {:ok, %AetherATProtoCore.Record{
        type: "app.bsky.feed.post",
        data: %{"text" => "Hello", "createdAt" => "2024-01-15T12:00:00Z"}
      }}

      iex> AetherATProtoCore.Record.from_map(%{"text" => "Missing type"})
      {:error, :missing_type}

      iex> AetherATProtoCore.Record.from_map(%{"$type" => "InvalidType"})
      {:error, :invalid_type}
  """
  ...
  ## Examples
      ...
      iex> record = %AetherATProtoCore.Record{
      ...>   type: "app.bsky.feed.post",
      ...>   data: %{"text" => "Hello", "createdAt" => "2024-01-15T12:00:00Z"}
      ...> }
      iex> AetherATProtoCore.Record.to_map(record)
      %{
        "$type" => "app.bsky.feed.post",
        "text" => "Hello",
        "createdAt" => "2024-01-15T12:00:00Z"
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.Record.valid_type?("app.bsky.feed.post")
      true

      iex> AetherATProtoCore.Record.valid_type?("com.example.myapp.record")
      true

      iex> AetherATProtoCore.Record.valid_type?("InvalidType")
      false

      iex> AetherATProtoCore.Record.valid_type?("single")
      false
  """
  ...
  ## Examples
      ...
      ...>   data: %{"text" => "Original"}
      ...> }
      iex> updated = AetherATProtoCore.Record.put_in_data(record, "text", "Updated")
      ...
      ...>   data: %{"text" => "Hello"}
      ...> }
      iex> updated = AetherATProtoCore.Record.put_in_data(record, "likes", 42)
      iex> updated.data
      %{"text" => "Hello", "likes" => 42}
  """
  ...
  ## Examples
      ...
      ...> }
      iex> AetherATProtoCore.Record.get_from_data(record, "text")
      "Hello"
      ...
      ...>   data: %{"text" => "Hello"}
      ...> }
      iex> AetherATProtoCore.Record.get_from_data(record, "likes", 0)
      0
  """
