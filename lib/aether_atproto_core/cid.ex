defmodule AetherATProtoCore.CID do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.CID.parse_cid("QmY7Yh4UquoXHLPFo2XbhXkhBvFoPwmQUSa92pxnxjQuPU")
      {:ok, %AetherATProtoCore.CID{version: 0, codec: "dag-pb", hash: "QmY7Yh4UquoXHLPFo2XbhXkhBvFoPwmQUSa92pxnxjQuPU", multibase: "base58btc"}}

      iex> AetherATProtoCore.CID.parse_cid("bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi")
      {:ok, %AetherATProtoCore.CID{version: 1, codec: "dag-cbor", hash: "bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi", multibase: "base32"}}
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.CID.valid_cid?("QmY7Yh4UquoXHLPFo2XbhXkhBvFoPwmQUSa92pxnxjQuPU")
      true

      iex> AetherATProtoCore.CID.valid_cid?("invalid")
      false

      iex> AetherATProtoCore.CID.valid_cid?(%AetherATProtoCore.CID{version: 1, hash: "bafy..."})
      true
  """
  ...
  ## Examples
      ...
      iex> cid = %AetherATProtoCore.CID{hash: "QmY7Yh4UquoXHLPFo2XbhXkhBvFoPwmQUSa92pxnxjQuPU"}
      iex> AetherATProtoCore.CID.cid_to_string(cid)
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.CID.cid_version("QmY7Yh4UquoXHLPFo2XbhXkhBvFoPwmQUSa92pxnxjQuPU")
      0

      iex> AetherATProtoCore.CID.cid_version("bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi")
      1

      iex> AetherATProtoCore.CID.cid_version("invalid")
      {:error, :invalid_cid}
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.CID.cid_codec("QmY7Yh4UquoXHLPFo2XbhXkhBvFoPwmQUSa92pxnxjQuPU")
      "dag-pb"

      iex> AetherATProtoCore.CID.cid_codec("bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi")
      "dag-cbor"
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.CID.is_cidv0?("QmY7Yh4UquoXHLPFo2XbhXkhBvFoPwmQUSa92pxnxjQuPU")
      true

      iex> AetherATProtoCore.CID.is_cidv0?("bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi")
      false
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.CID.is_cidv1?("bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi")
      true

      iex> AetherATProtoCore.CID.is_cidv1?("QmY7Yh4UquoXHLPFo2XbhXkhBvFoPwmQUSa92pxnxjQuPU")
      false
  """
  ...
  ## Examples
      ...
      iex> AetherATProtoCore.CID.new(1, "dag-cbor", "bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi")
  ...
  ## Examples
      ...
      iex> {:ok, cid} = AetherATProtoCore.CID.parse_cid("bafyreie5cvv4h45feadgeuwhbcutmh6t2ceseocckahdoe6uat64zmz454")
      iex> bytes = AetherATProtoCore.CID.cid_to_bytes(cid)
      iex> is_binary(bytes)
      true
  """
  ...
  ## Examples
      ...
      iex> {:ok, cid} = AetherATProtoCore.CID.parse_cid("bafyreie5cvv4h45feadgeuwhbcutmh6t2ceseocckahdoe6uat64zmz454")
      iex> bytes = AetherATProtoCore.CID.cid_to_bytes(cid)
      iex> {:ok, parsed, <<>>} = AetherATProtoCore.CID.parse_cid_bytes(bytes)
