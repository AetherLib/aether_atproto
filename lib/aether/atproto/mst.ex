defmodule Aether.ATProto.MST do
  @moduledoc """
  ...
  ```elixir
  # Create a new MST
  mst = %Aether.ATProto.MST{}

  # Add entries
  {:ok, mst} = Aether.ATProto.MST.add(mst, "app.bsky.feed.post/abc", value_cid)
  {:ok, mst} = Aether.ATProto.MST.add(mst, "app.bsky.feed.post/xyz", value_cid)

  # Get an entry
  {:ok, cid} = Aether.ATProto.MST.get(mst, "app.bsky.feed.post/abc")

  # List all entries
  entries = Aether.ATProto.MST.list(mst)

  # Delete an entry
  {:ok, mst} = Aether.ATProto.MST.delete(mst, "app.bsky.feed.post/abc")
  ```

  ## Storage

  The MST can work with different storage backends by implementing
  the `Aether.ATProto.MST.NodeStore` behavior. This allows you to store
  nodes in memory, Ecto, Mnesia, or any other backend.
  """

  alias Aether.ATProto.CID
  alias Aether.ATProto.MST.Entry
  ...
  ## Examples
      ...
      iex> mst = %Aether.ATProto.MST{}
      iex> cid = Aether.ATProto.CID.parse_cid!("bafyreie5cvv4h45feadgeuwhbcutmh6t2ceseocckahdoe6uat64zmz454")
      iex> {:ok, mst} = Aether.ATProto.MST.add(mst, "app.bsky.feed.post/abc", cid)
      iex> {:ok, ^cid} = Aether.ATProto.MST.get(mst, "app.bsky.feed.post/abc")
      iex> :ok
      :ok
  """
  ...
  ## Examples
      ...
      iex> mst = %Aether.ATProto.MST{}
      iex> Aether.ATProto.MST.get(mst, "app.bsky.feed.post/abc")
      {:error, :not_found}
  """
  ...
  ## Examples
      ...
      iex> cid = Aether.ATProto.CID.parse_cid!("bafyreie5cvv4h45feadgeuwhbcutmh6t2ceseocckahdoe6uat64zmz454")
      iex> {:ok, mst} = Aether.ATProto.MST.add(mst, "app.bsky.feed.post/abc", cid)
      iex> {:ok, mst} = Aether.ATProto.MST.delete(mst, "app.bsky.feed.post/abc")
      iex> Aether.ATProto.MST.get(mst, "app.bsky.feed.post/abc")
      {:error, :not_found}
  """
  ...
  ## Examples
      ...
      iex> mst = %Aether.ATProto.MST{}
      iex> Aether.ATProto.MST.list(mst)
      []
  """
  ...
  ## Examples
      ...
      iex> depth = Aether.ATProto.MST.calculate_key_depth("app.bsky.feed.post/abc")
