defmodule Aether.ATProto.Commit do
  @moduledoc """
  ...
  {:ok, signed_commit} = Aether.ATProto.Commit.sign(commit, signing_key)

  # Verify a commit signature
  {:ok, valid?} = Aether.ATProto.Commit.verify(signed_commit, public_key)
  ```
  ...
  ## Examples
      ...
      iex> mst_cid = Aether.ATProto.CID.parse_cid!("bafyreie5cvv4h45feadgeuwhbcutmh6t2ceseocckahdoe6uat64zmz454")
      iex> prev_cid = Aether.ATProto.CID.parse_cid!("bafyreibvjvcv745gig4mvqs4hctx4zfkono4rjejm2ta6gtyzkqxfjeily")
      iex> commit = Aether.ATProto.Commit.create_next("did:plc:abc123", mst_cid, prev_cid)
      iex> commit.prev
      prev_cid
  """
  ...
  ## Examples
      ...
      # Sign the commit
      {:ok, signed_commit} = Aether.ATProto.Commit.sign(commit, signing_fn)
  """
  ...
  ## Examples
      ...
      # Verify the commit
      {:ok, true} = Aether.ATProto.Commit.verify(commit, verify_fn)
  """
  ...
  ## Examples
      ...
      iex> commit = %Aether.ATProto.Commit{sig: nil}
      iex> Aether.ATProto.Commit.signed?(commit)
      false

      iex> commit = %Aether.ATProto.Commit{sig: <<1, 2, 3>>}
      iex> Aether.ATProto.Commit.signed?(commit)
      true
  """
  ...
  ## Examples
      ...
      iex> mst_cid = Aether.ATProto.CID.parse_cid!("bafyreie5cvv4h45feadgeuwhbcutmh6t2ceseocckahdoe6uat64zmz454")
      iex> commit = Aether.ATProto.Commit.create("did:plc:abc123", mst_cid)
      iex> Aether.ATProto.Commit.validate(commit)
      :ok
  """
  ...
  ## Examples
      ...
      iex> Aether.ATProto.Commit.compare_revs("3jzfcijpj2z2a", "3jzfcijpj2z29")
      :gt
  """
