# lib/crypto/p256.ex
defmodule Aether.Crypto.P256 do
  @moduledoc """
  P-256 (secp256r1) cryptographic operations and keypair management.
  """
  ...
  def verify_did_sig(did, data, sig, opts \\ []) do
    ...
    if parsed.jwt_alg != @jwt_alg do
      raise ArgumentError, "Not a P-256 did:key: #{did}"
    end
  ...
  @doc """
  Decompresses a P-256 public key.
  """
